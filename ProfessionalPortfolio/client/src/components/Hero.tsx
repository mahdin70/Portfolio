...
import { 
  Github, Linkedin, ExternalLink, Terminal, Code, 
  Braces, ArrowRight, Sparkles, Star, ChevronDown,
  Database, Globe, Server, Cpu, MonitorSmartphone, 
  BrainCircuit, CloudLightning
} from "lucide-react";
    ...
    <section id="about" className="relative pt-28 md:pt-36 pb-16 md:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      >
        <motion.div className="lg:col-span-7" variants={itemVariants}>
          ...
          >
            <div className="terminal-text font-mono text-lg md:text-xl text-foreground/80">
          ...
          >
            ...
            <p className="text-sm md:text-base text-foreground/90 leading-relaxed">
              Highly motivated Software Engineering student with interests in Software Development, Generative AI, and Software Product Management. Passionate about solving challenges and contributing to innovative organizations with an organized and fast-learning mindset.
            </p>
      ...
      <motion.div 
        ...
        animate="visible"
      >
        <motion.div className="font-mono text-sm text-muted-foreground" variants={itemVariants}>
          // Find me on:
        </motion.div>
        
        <motion.a 
          href="https://github.com/mahdinm"
          target="_blank"
      ...
      <motion.div 
        className="absolute bottom-4 left-1/2 -translate-x-1/2 text-foreground/50 flex flex-col items-center"

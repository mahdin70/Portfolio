...
const TimelineItem = ({ 
  ...
  <div className="relative pl-10 pb-8 group">
    {/* Timeline dot */}
    <div className="absolute left-0 top-[6px] w-5 h-5 rounded-full bg-secondary/20 border-2 border-secondary flex items-center justify-center z-10 
    ...
    {/* Timeline line */}
    {!isLast && (
      <div className="absolute left-[9px] top-6 w-[2px] h-[calc(100%-12px)] bg-gradient-to-b from-secondary/50 to-secondary/5" />
    )}
